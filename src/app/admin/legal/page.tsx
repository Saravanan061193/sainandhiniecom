    ...
    return (
        <div className="space-y-8">
            <div className="flex justify-between items-center bg-white p-8 rounded-[2rem] shadow-sm border border-gray-100">
                <div>
                    <h1 className="text-3xl font-serif font-bold text-primary-dark">Legal Pages Management</h1>
                    <p className="text-gray-400 mt-1 font-medium">Edit content for Terms, Privacy, and other legal pages.</p>
                </div>
                ...
                <div className="space-y-2">
                    {Object.keys(defaultTitles).map((key) => (
                        <button
                            ...
                            className={`w-full text-left px-6 py-4 rounded-xl font-bold text-sm transition-all flex items-center justify-between ${selectedPage === key
                ...
                <div className="md:col-span-3 bg-white p-8 rounded-[2rem] shadow-sm border border-gray-100 min-h-[500px] relative">
                    {loading ? (
                        ...
                        <div className="space-y-6">
                            <div>
                                <label className="block text-xs font-black uppercase tracking-widest text-gray-400 mb-2">Page Title</label>
                                <input
                                    type="text"
                                    value={title}
                            ...
                            <div>
                                <label className="block text-xs font-black uppercase tracking-widest text-gray-400 mb-2">Content (Markdown / HTML Supported)</label>
                                <textarea
                                    value={content}
                                ...
                                <p className="text-[10px] text-gray-400 mt-2 font-medium">
                                    Tip: You can use basic HTML tags for formatting (e.g., &lt;b&gt;, &lt;h2&gt;, &lt;ul&gt;).
                                </p>
                            </div>
