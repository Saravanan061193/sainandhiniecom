    ...
    return (
        <div className="space-y-8">
            <header className="flex justify-between items-end">
                <div>
                    <span className="text-primary font-bold uppercase tracking-[0.3em] text-xs mb-2 block">Marketing Tools</span>
                    <h1 className="text-4xl font-serif font-bold text-primary-dark">Promo <span className="text-primary italic">Codes</span></h1>
                </div>
                <button
            ...
            {coupons.length === 0 ? (
                <div className="bg-white rounded-[3rem] p-20 text-center border border-gray-100 flex flex-col items-center">
                    ...
                    <h2 className="text-2xl font-serif font-bold text-primary-dark mb-2">No Active Coupons</h2>
                    <p className="text-gray-400 max-w-md mx-auto mb-8">Create discount codes to boost sales and reward customers.</p>
                </div>
            ) : (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {coupons.map((coupon) => (
                        <div key={coupon._id} className="bg-white p-8 rounded-[2.5rem] shadow-sm border border-gray-50 group hover:border-primary/20 transition-all relative overflow-hidden">
                            ...
                            <div className="flex justify-between items-start mb-6">
                                ...
                                <div className="w-10 h-10 rounded-full bg-secondary/20 flex items-center justify-center text-primary-dark">
                                    {coupon.discountType === 'percentage' ? <Percent size={18} /> : <Coins size={18} />}
                                </div>
                            </div>
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <p className="text-[10px] uppercase font-bold text-gray-400 tracking-widest mt-1">
                                        {coupon.minOrderValue > 0 ? `Min. Order: ₹${coupon.minOrderValue}` : 'No Minimum Order'}
                                    </p>
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                        ...
                        >
                            <div className="p-8 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
                                <h2 className="text-xl font-serif font-bold text-primary-dark">New Coupon</h2>
                                <button onClick={() => setIsModalOpen(false)} className="w-10 h-10 rounded-full bg-white border border-gray-100 flex items-center justify-center text-gray-400 hover:bg-red-50 hover:text-red-500 transition-all">
                                    <X size={18} />
                                </button>
                            </div>
                            ...
                            <form onSubmit={handleSubmit} className="p-8 space-y-6">
                                ...
                                <div className="grid grid-cols-2 gap-6">
                                    ...
                                    <div className="space-y-2">
                                        <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest ml-1">Limit Per User</label>
                                        <input
                                            type="number"
                                ...
                                <div className="grid grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest ml-1">Valid From</label>
                                        <input
                                            type="date"
                                    ...
                                    <div className="space-y-2">
                                        <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest ml-1">Valid Until (Expiry)</label>
                                        <input
                                            type="date"
