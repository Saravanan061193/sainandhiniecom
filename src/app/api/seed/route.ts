...
export async function GET() {
    try {
        ...
        const categoriesData = [
            { name: "Sweets", slug: "sweets", description: "Authentic Traditional Sweets" },
            { name: "Snacks", slug: "snacks", description: "Crunchy Savory Snacks" },
            { name: "Pickles", slug: "pickles", description: "Spicy Homemade Pickles" }
        ];
        ...
        const subCategoriesData = [
            ...
            { name: "Traditional Snacks", slug: "traditional-snacks", parent: "Snacks" },
        ...
        const productsData = [
            {
                ...
                description: "Melt-in-your-mouth Mysore Pak made with generous amounts of pure ghee.",
            ...
            },
            {
                name: "Kaju Katli",
                slug: "kaju-katli",
                description: "Rich cashew fudge with a silver varq finish. Perfect for gifting.",
                price: 1200,
                category: "Sweets",
            ...
            },
            {
                name: "Butter Murukku",
                slug: "butter-murukku",
                description: "Crunchy, spiral-shaped savory snack made with rice flour and butter.",
                price: 400,
                category: "Snacks",
                ...
                images: ["https://images.pexels.com/photos/4051610/pexels-photo-4051610.jpeg?auto=compress&cs=tinysrgb&w=800"],
                stock: 130,
                badge: "Fresh"
            },
            {
                name: "Madras Mixture",
                slug: "madras-mixture",
                description: "Spicy blend of deep-fried lentils, peanuts, curry leaves, and spices.",
                price: 420,
                category: "Snacks",
            ...
            },
            {
                name: "Mango Thokku",
                slug: "mango-thokku",
                description: "Tangy and spicy grated mango pickle made with sesame oil.",
                price: 350,
                category: "Pickles",
                ...
                images: ["https://images.pexels.com/photos/674483/pexels-photo-674483.jpeg?auto=compress&cs=tinysrgb&w=800"],
                stock: 105,
                badge: "Homemade"
            }
        ];
