                ...
                <div className="glass-card p-10">
                    <div className="text-center mb-10">
                        <Link href="/" className="inline-flex items-center gap-2 mb-6">
                            <div className="w-10 h-10 bg-primary rounded-lg flex items-center justify-center text-white font-bold text-xl shadow-lg">S</div>
                            <span className="text-2xl font-serif font-bold text-primary-dark">Sai Nandhini</span>
                        </Link>
                        <h2 className="text-3xl font-serif font-bold text-primary-dark">Create Account</h2>
                        <p className="text-gray-500 mt-2 font-medium">Join us for a world of authentic flavors</p>
                    </div>
