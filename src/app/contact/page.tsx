            ...
            <div className="pt-48 pb-32 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
                    ...
                    <div className="lg:col-span-4 space-y-8">
                        {[
                            { title: "Visit Us", content: "123 Temple Street, Heritage Square, Chennai - 600001", icon: MapPin },
                            { title: "Call Us", content: "+91 98765 43210 / +91 44 2345 6789", icon: Phone },
                            { title: "Email Us", content: "support@sainandhinitasty.com / sales@sainandhinitasty.com", icon: Mail },
                        ].map((item, i) => (
                            <motion.div
                                key={i}
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-500 font-medium leading-relaxed text-sm">{item.content}</p>
                                </div>
                            </motion.div>
                        ))}
                        ...
                        <div className="bg-primary-dark p-10 rounded-[3rem] text-white relative overflow-hidden">
                            ...
                            <h3 className="text-xl font-serif font-bold mb-4">Bulk Orders?</h3>
                            <p className="text-primary-light text-sm font-medium mb-6">Planning a wedding or a corporate event? We handle bulk orders with custom branding.</p>
                            <button className="text-xs font-bold uppercase tracking-widest text-accent hover:underline">Connect with Sales →</button>
                        </div>
                    </div>
                            ...
                            <form className="space-y-8">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    <div className="space-y-2">
                                        ...
                                        <input type="text" placeholder="John Doe" className="w-full bg-gray-50 border border-transparent focus:border-primary/10 rounded-2xl py-5 px-8 outline-none transition-all font-medium" />
                                    </div>
                                    <div className="space-y-2">
                                        <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest ml-1">Email Address</label>
                                        <input type="email" placeholder="john@example.com" className="w-full bg-gray-50 border border-transparent focus:border-primary/10 rounded-2xl py-5 px-8 outline-none transition-all font-medium" />
                                    </div>
                                </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <textarea rows={6} placeholder="How can we help you today?" className="w-full bg-gray-50 border border-transparent focus:border-primary/10 rounded-2xl py-6 px-8 outline-none transition-all font-medium" />
                                </div>
                                ...
                                <button className="w-full bg-primary text-white py-6 rounded-2xl font-bold text-lg flex items-center justify-center gap-3 hover:bg-primary-dark transition-all shadow-xl active:scale-95 group">
                                    Send Deep Message <Send size={20} className="group-hover:-translate-y-1 group-hover:translate-x-1 transition-transform" />
                                </button>
                            </form>
                        </motion.div>
                    </div>
