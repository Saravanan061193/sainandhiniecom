...
export default function FreshBanner() {
    const [banner, setBanner] = useState("https://images.pexels.com/photos/1721932/pexels-photo-1721932.jpeg?auto=compress&cs=tinysrgb&w=1600");
    ...
    return (
        <section className="relative h-[500px] flex items-center justify-center overflow-hidden my-20">
            ...
            >
                <span className="text-secondary font-black tracking-[0.4em] uppercase text-xs mb-4 block">Our Heritage</span>
