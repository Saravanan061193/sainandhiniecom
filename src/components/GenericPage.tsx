        ...
        return (
            <main className="min-h-screen bg-white">
                ...
                <div className="min-h-screen flex flex-col items-center justify-center px-4 text-center">
                    <h1 className="text-4xl font-serif font-bold text-gray-400 mb-4 tracking-tighter">Content Coming Soon</h1>
                    <p className="text-gray-500 max-w-md mx-auto mb-8 font-medium">We are updating our policies. Please check back later.</p>
                    <a href="/" className="bg-primary text-white px-8 py-3 rounded-2xl font-black uppercase tracking-widest text-[10px]">Back Home</a>
                </div>
                <Footer />
            </main>
        );
